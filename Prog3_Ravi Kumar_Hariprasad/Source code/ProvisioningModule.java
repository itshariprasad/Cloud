...
public abstract class ProvisioningModule implements Runnable {
    ...
    public void run() {
        ...
        String initScript = "#!/bin/bash\n" +
                ...
                "ant worker -f /home/ec2-user/cs553-cloudcomputing-2014/assignment3/build.xml -Darg0=-i -Darg1=" + killTime + " &>> /var/log/sqs_worker.log &";
        String base64script = Base64.encodeAsString(initScript.getBytes());
        runInstancesRequest = new RunInstancesRequest()
                .withImageId(ami)
                .withInstanceType(instanceType)
                .withSecurityGroupIds("assignment3")
                .withKeyName("pa4sqs")
                .withMinCount(1)
                .withMaxCount(1)
